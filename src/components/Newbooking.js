                ...
                {load ?
                    ...
                    <div style={{ display: 'flex' }}>
                        ...
                        <div style={{ overflowX: 'scroll' }}>
                            ...
                            <BookingDay3 isview = {false} onLoader={onLoader} dateselect={data.dateselect}/>
                        </div>
                    </div>
                }
            </div>
                ...
                {load ?
                    ...
                    <div style={{ display: 'flex' }}>
                        ...
                        <div style={{ overflowX: 'scroll' }}>
                            ...
                            <BookingDay2 isview = {false} onLoader={onLoader} dateselect={data.dateselect}/>
                        </div>
                    </div>
                }
            </div>
                ...
                {load ?
                    ...
                    <div style={{ display: 'flex' }}>
                        ...
                        <div style={{ overflowX: 'scroll' }}>
                            ...
                            <BookingDay1 isview = {false} onLoader={onLoader} dateselect={data.dateselect}/>
                        </div>
                    </div>
                }
            </div>
