...
function CancelBookingDay1(props){
    ...
    return (
        <div>
            <div className="boxes">
                ...
                <CancelBookingPopup display={popup} setPopup={setPopup} bookingList={bkList} onLoader={props.onLoader} getData={getTimetoday}/>
            </div>
        </div>
    )
}

export default CancelBookingDay1;