...
function CancelBookingDay3(props){
    ...
    const [d3_time1,setD3_time1] = useState([]);
    const [d3_time2,setD3_time2] = useState([]);
    const [d3_time3,setD3_time3] = useState([]);
    const [d3_time4,setD3_time4] = useState([]);
    const [d3_time5,setD3_time5] = useState([]);
    const [d3_time6,setD3_time6] = useState([]);
    const [d3_time7,setD3_time7] = useState([]);

    const db = getFirestore(appdb);
    const docRoom = collection(db,'rooms');

    const docD3_time1 = collection(db,'d3_time1');
    const docD3_time2 = collection(db,'d3_time2');
    const docD3_time3 = collection(db,'d3_time3');
    const docD3_time4 = collection(db,'d3_time4');
    const docD3_time5 = collection(db,'d3_time5');
    const docD3_time6 = collection(db,'d3_time6');
    const docD3_time7 = collection(db,'d3_time7');
    ...
    const getTimetwo = async ()=>{
        const dbD3_time1 = await getDocs(docD3_time1);
        const dbD3_time2 = await getDocs(docD3_time2);
        const dbD3_time3 = await getDocs(docD3_time3);
        const dbD3_time4 = await getDocs(docD3_time4);
        const dbD3_time5 = await getDocs(docD3_time5);
        const dbD3_time6 = await getDocs(docD3_time6);
        const dbD3_time7 = await getDocs(docD3_time7);

        setD3_time1(dbD3_time1.docs.map((item)=>{
            return {...item.data(),id: item.id}
        }));
        setD3_time2(dbD3_time2.docs.map((item)=>{
            return {...item.data(),id: item.id}
        }));
        setD3_time3(dbD3_time3.docs.map((item)=>{
            return {...item.data(),id: item.id}
        }));
        setD3_time4(dbD3_time4.docs.map((item)=>{
            return {...item.data(),id: item.id}
        }));
        setD3_time5(dbD3_time5.docs.map((item)=>{
            return {...item.data(),id: item.id}
        }));
        setD3_time6(dbD3_time6.docs.map((item)=>{
            return {...item.data(),id: item.id}
        }));
        setD3_time7(dbD3_time7.docs.map((item)=>{
            return {...item.data(),id: item.id}
        }));
    ...
    return (
        <div>
            <div className="boxes">
                ...
                <CancelBookingPopup display={popup} setPopup={setPopup} bookingList={bkList} onLoader={props.onLoader} getData={getTimetwo}/>
            </div>
        </div>
    )
}

export default CancelBookingDay3;